...
-- ==========================================
-- MODERN STYLE WITH GLOW EFFECTS (Blue Theme)
-- ==========================================
local Library = {
    Registry = {};
    RegistryMap = {};
    ...
    LightOutline = Color3.fromRGB(60, 60, 60);

    Black = Color3.new(0, 0, 0);
    Font = Enum.Font.Gotham; -- 더 현대적인 폰트
...
-- 글로우 효과 추가 함수
function Library:AddGlow(Instance, Color, Transparency, Size)
    local Glow = Library:Create('UIStroke', {
        Color = Color or Library.GlowColor;
        Transparency = Transparency or Library.GlowTransparency;
        Thickness = Size or Library.GlowSize;
...
function Library:AddToolTip(InfoStr, HoverInstance)
    ...
    Library:AddGlow(Tooltip, Library.AccentColor, 0.7, 1);
...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        Library:AddCorner(CheckerFrame, UDim.new(0, 3));

        local PickerFrameOuter = Library:Create('Frame', {
            Name = 'Color';
            BackgroundColor3 = Library.BackgroundColor;
            Position = UDim2.fromOffset(DisplayFrame.AbsolutePosition.X, DisplayFrame.AbsolutePosition.Y + 18),
            Size = UDim2.fromOffset(220, Info.Transparency and 260 or 245);
            Visible = false;
            ZIndex = 15;
            Parent = ScreenGui,
        });
        ...
        Library:AddGlow(PickerFrameOuter, Library.AccentColor, 0.6, 1);
        ...
        Library:AddCorner(CursorOuter, UDim.new(1, 0));

        local HueSelectorOuter = Library:Create('Frame', {
            BackgroundColor3 = Library.BackgroundColor;
            Position = UDim2.new(0, 194, 0, 28);
        ...
        local HueBoxOuter = Library:Create('Frame', {
            BackgroundColor3 = Library.BackgroundColor;
            Position = UDim2.fromOffset(8, 214),
        ...
        local RgbBoxOuter = Library:Create('Frame', {
            BackgroundColor3 = Library.BackgroundColor;
            Position = UDim2.new(0.5, 4, 0, 214),
            Size = UDim2.new(0.5, -12, 0, 22),
            ZIndex = 18,
            Parent = PickerFrameInner;
        });
        Library:AddCorner(RgbBoxOuter, UDim.new(0, 3));
        ...
        do
            ...
            Library:AddGlow(ContextMenu.Container, Library.AccentColor, 0.7, 1);
    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        Library:AddGlow(ModeSelectOuter, Library.AccentColor, 0.7, 1);
        ...
        function KeyPicker:Update()
            ...
            Library.KeybindFrame.Size = UDim2.new(0, math.max(XSize + 10, 200), 0, YSize + 28)
        end;
...
do
    ...
    function Funcs:AddButton(...)
        ...
        local function CreateBaseButton(Button)
            ...
            Library:AddCorner(Outer, UDim.new(0, 4));
    ...
    function Funcs:AddInput(Idx, Info)
        ...
        Library:AddCorner(TextBoxOuter, UDim.new(0, 4));
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        Library:AddCorner(ToggleInner, UDim.new(0, 2));
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        SliderOuter.InputBegan:Connect(function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 and not Library:MouseIsOverOpenedFrame() then
                while InputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1) do
                    local MinX = SliderOuter.AbsolutePosition.X;
                    local MaxX = MinX + SliderOuter.AbsoluteSize.X;
                    local MouseX = math.clamp(Mouse.X, MinX, MaxX);

                    local Percent = (MouseX - MinX) / (MaxX - MinX);
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        Library:AddCorner(DropdownOuter, UDim.new(0, 4));
        ...
        Library:AddGlow(ListOuter, Library.AccentColor, 0.7, 1);
        ...
        local function RecalculateListSize(YSize)
            ListOuter.Size = UDim2.fromOffset(DropdownOuter.AbsoluteSize.X, YSize or (MAX_DROPDOWN_ITEMS * 20 + 8))
        end;
        ...
        function Dropdown:BuildDropdownList()
            ...
            Scrolling.CanvasSize = UDim2.fromOffset(0, (Count * 20) + 4);

            local Y = math.clamp(Count * 20, 0, MAX_DROPDOWN_ITEMS * 20) + 8;
...
function Library:SetWatermark(Text)
    ...
    Library.Watermark.Size = UDim2.new(0, X + 20, 0, 24);
...
function Library:CreateWindow(...)
    ...
    Library:AddCorner(TitleBar, UDim.new(0, 6));

    -- 하단 모서리 숨기기용
    local TitleBarFix = Library:Create('Frame', {
        BackgroundColor3 = Library.MainColor;
    ...
    Library:AddToRegistry(TitleBarFix, {
        BackgroundColor3 = 'MainColor';
    });
